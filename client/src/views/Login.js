        ...
        <div className="col-6 col-sm-0">
          <div className="card p-2">
            <div className="row d-flex justify-content-center">
              <img
                src="https://lh3.googleusercontent.com/proxy/xAmqaZIjWkPJcawAVul3zm91s0E7agVC4GtMsIQct38lDJAAn7pBHl2NbApjfK_b9UOuwEVCd1haOhQ0hcerH5qNLtjkz4Yqoyy4V2XAXUvEAo8V7KOp94g"
                alt="com logo"
                height="200"
                width="200"
              />
